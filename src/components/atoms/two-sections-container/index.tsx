...
const TwoSectionContainer: React.FC<Props> = ({
  ...
  return (
    <section className="tw-grid tw-grid-cols-2 | tw-min-h-[577px] tw-w-[912px] | tw-rounded-2xl tw-overflow-hidden | tw-shadow-lg">
      <div
        className={tmsx(
      ...
      <div
        className={tmsx(
          "tw-bg-white | tw-p-6 | tw-flex tw-flex-col tw-gap-8 tw-justify-center tw-items-center | tw-overflow-y-auto",
          rightChildClassName
        )}
      >
        {rightChild}
